    ...
    <div class="bg-surface-container-high rounded-2xl shadow-sm border border-outline-variant overflow-hidden">
        ...
        <form method="GET" action="{{ route('admin.admins.index') }}" class="p-4 lg:p-5 border-b border-outline-variant bg-surface-container-high flex flex-col sm:flex-row gap-4 items-center justify-start">
            <div class="relative w-full sm:w-80">
                ...
                <input type="text" name="search" value="{{ request('search') }}" class="input input-sm h-10 w-full pl-10 rounded-xl bg-surface-container border-none focus:ring-2 focus:ring-primary text-on-surface" placeholder="Cari nama atau email...">
            </div>
                            ...
                            <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="password" placeholder="Min. 8 karakter, huruf besar, kecil & angka" class="input input-bordered w-full rounded-xl bg-surface focus:border-primary text-on-surface {{ (old('admin_id') == $admin->id && $errors->has('password')) ? 'border-error focus:border-error' : '' }}">
                                        @if(old('admin_id') == $admin->id)
                                            @error('password')
                                                <span class="text-error text-xs mt-1 block">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="password_confirmation" placeholder="Opsional (isi jika mengubah password)" class="input input-bordered w-full rounded-xl bg-surface focus:border-primary text-on-surface">
                                    </div>
                                </div>
        ...
        <form action="{{ route('admin.admins.store') }}" method="POST">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input type="password" name="password" placeholder="Min. 8 karakter, huruf besar, kecil & angka" class="input input-bordered w-full rounded-xl bg-surface focus:border-primary text-on-surface {{ (!old('admin_id') && $errors->has('password')) ? 'border-error focus:border-error' : '' }}">
                    @if(!old('admin_id'))
                        @error('password')
                            <span class="text-error text-xs mt-1 block">{{ $message }}</span>
                        @enderror
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" placeholder="Ulangi password" class="input input-bordered w-full rounded-xl bg-surface focus:border-primary text-on-surface">
                </div>
